...
public class reverseList_206 {
    public mergeTwoLists_021.ListNode reverseList(mergeTwoLists_021.ListNode head){
        //两个全局变量指针，一个临时指针定义在循环结构里面
        mergeTwoLists_021.ListNode cur = head;
        mergeTwoLists_021.ListNode pre = null;
        while (cur.next != null) {
            //tmp指针先走，找到cur的下一个，存下来。
            mergeTwoLists_021.ListNode tmp = cur.next;
            //先将头指针的下一位置为null
            cur.next = pre;
